...
1. **Paire générée automatiquement :** créée pour `pgp=encrypt` lorsque le stockage persistant et l'option d'asset `pgp_autogen` sont activés ; `pgp=sign` ne génère pas de clés
