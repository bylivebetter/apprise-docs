...
- [**Jira**](https://github.com/caronc/apprise/blob/master/apprise/plugins/jira.py) : met en cache les identifiants d'alerte afin que les actions `acknowledge`, `close`, `note` et `delete` retrouvent les alertes existantes sans redemander leur identifiant.
...
- [**Opsgenie**](https://github.com/caronc/apprise/blob/master/apprise/plugins/opsgenie.py) : met en cache les identifiants d'alerte afin que les actions `acknowledge`, `close`, `note` et `delete` retrouvent les alertes existantes sans redemander leur identifiant.
